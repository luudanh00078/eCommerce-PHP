...
?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            ...
            <h2 class="sub-title">#New autumn winter fashion Collection 2019</h2>
        ...
        <div class="row align-items-stretch">
          <div class="col-lg-8">
            <div class="product-item sm-height full-height bg-gray">
              <a href="women.php" class="product-category">Women <span>25 items</span></a>
              <img src="../images/model_4.png" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4">
            <div class="product-item sm-height bg-gray mb-4">
              <a href="men.php" class="product-category">Men <span>25 items</span></a>
              <img src="../images/model_5.png" alt="Image" class="img-fluid">
            </div>

            <div class="product-item sm-height bg-gray">
              <a href="shoes.php" class="product-category">Shoes <span>25 items</span></a>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="title-section mb-5">
            <h2 class="text-uppercase"><span class="d-block">MOST RATED</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 block-3">
            <div class="nonloop-block-3 owl-carousel">
              <?php foreach($rsRDom as $value){?>
              <div class="item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            ...
            <h1>New Shoes</h1>
            <p><a href="shoes.php" class="btn btn-black rounded-0">Shop Now</a></p>
            </div>
          </div>
          <div class="col-md-6 order-1 align-self-end">
            <img src="../images/model_6.png" alt="Image" class="img-fluid">
